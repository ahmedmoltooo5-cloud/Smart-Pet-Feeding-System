...
import { PawPrint, Lock, Phone, FileText, AlertCircle } from "lucide-react";
...
export function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!petName || !petDetails || !ownerPhone || !password) {
    ...
    const result = await signup(petName, petDetails, ownerPhone, password);
    ...
    if (result.success) {
      ...
      setError(result.error ?? "Pet name already exists");
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-12">
      <div className="w-full max-w-md px-6">
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <p className="text-center text-gray-500 mb-8">Set up your smart pet feeder</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all resize-none"
                  placeholder="Breed, type, age, etc."
                  rows={3}
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-gray-700 mb-2">Owner Phone Number</label>
              <div className="relative">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/login" className="text-purple-500 hover:text-purple-600 transition-colors">
                Login
              </Link>
            </p>
          </div>
